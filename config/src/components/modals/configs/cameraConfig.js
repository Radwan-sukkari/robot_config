...
export const cameraConfig = {
  ...
  fields: [
    {
      ...
      options: [
        // { value: "", label: "Select camera type" },
        {
          value: "Orbbec 300",
          label: "Orbbec 300",
          selected: configState.camera.data.type === "Orbbec 300",
        },
        {
          value: "Photoneo MotionCam",
          label: "Photoneo MotionCam",
          selected: configState.camera.data.type === "Photoneo MotionCam",
        },
        {
          value: "Mechmind Nano",
          label: "Mechmind Nano",
          selected: configState.camera.data.type === "Mechmind Nano",
        },
      ],
    },
    {
  ...
  validate: (data) => {
    ...
    if (
      !validatePositiveNumber(data.width) ||
      !validatePositiveNumber(data.height)
    ) {
